...
```markdown
# OPENCLAW INITIALISATION DIRECTIVE: OS-Bridge-Manipulator
**Target Environment:** WSL2 (Ubuntu/Debian) bridged to Windows Host.

## System Objective
You must install, configure, and initialise the OS-Bridge-Manipulator Model Context Protocol (MCP) server. This server grants you high-performance, cross-environment filesystem manipulation, directory indexing, and instantaneous full-text search capabilities.
